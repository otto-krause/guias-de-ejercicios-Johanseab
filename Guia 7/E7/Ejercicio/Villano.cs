...
namespace Ejercicio
{
    public class Villano
    {
        ...
        public void premiar()
        {
            ...
            {
                case 0:
                throw new System.Exception("No hay ningun minion para la mision");
                default:
        ...
        public void sumarMaldadesRealizadas()=> minionsAplicados.ForEach(i=>i.sumarLaCantidadDeMaldadesRealizadas());
        ...
        public void robar(string objeto)
        {
            switch (objeto)
            {
                ...
                {
                    case 0:
                    throw new System.Exception("No hay ningun minon para la mision");
                    default:
                ...
                break;
                case "La Luna":
                minionsAplicados=minions.Where(i=>i.tieneUnaArmaCongelante()).ToList();
                switch (minionsAplicados.Count())
                {
                    case 0:
                    throw new System.Exception("No hay ningun minion para la mision");
